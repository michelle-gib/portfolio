...
const translations = {
  ...
  project1: {
    de: {
      title: "Nuruslums Website",
      "nav.backProjects": "Zurück zu Projekten",
      "hero.category": "Webdesign & Entwicklung",
      "hero.title": "Nuru Slums Website",
      "hero.text": "Weiterentwicklung und Optimierung einer bestehenden Website mit Fokus auf Struktur, Benutzerführung und einem klaren visuellen Auftritt.",
      "intro.title": "Projektbeschreibung",
      "intro.text": "Im Rahmen von AIP+ übernahm ich die Weiterentwicklung und Fertigstellung einer bestehenden Website für die Organisation Nuru Slums – Hope for Africa. Ziel war es, die Seite strukturell zu verbessern, benutzerfreundlicher zu gestalten und visuell klarer aufzubauen.",
      "facts.toolsLabel": "Tools",
      "facts.durationLabel": "Dauer",
      "facts.durationValue": "4 Monate",
      "facts.roleLabel": "Rolle",
      "facts.roleValue": "Design & Entwicklung",
      "problem.title": "Problem",
      "problem.text": "Die bestehende Website war in ihrer Struktur und Benutzerführung nicht optimal aufgebaut und wirkte visuell unruhig. Inhalte waren teilweise unklar angeordnet, wodurch die Orientierung für Nutzer erschwert wurde.",
      "solution.title": "Lösung",
      "solution.text": "Ich entwickelte eine klarere Seitenstruktur, optimierte die Navigation und gestaltete das Layout neu. Dabei lag der Fokus auf einer ruhigen visuellen Gestaltung, guter Lesbarkeit und einer benutzerfreundlichen Führung durch die Inhalte.",
      ...
      "result.alt": "Finales Website Mockup",
      "reflection.title": "Reflexion",
      "reflection.text": "Dieses Projekt hat mir gezeigt, wie entscheidend eine klare Struktur und eine gute Benutzerführung für die Wirkung einer Website sind. Die Arbeit an einer bestehenden Seite hat mir geholfen, meine Fähigkeiten in Analyse, Gestaltung und Umsetzung gezielt weiterzuentwickeln.",
    ...
    en: {
      ...
      "hero.title": "Nuru Slums Website",
      "hero.text": "Further development and optimization of an existing website with a focus on structure, user guidance, and a clear visual appearance.",
      "intro.title": "Project Description",
      "intro.text": "As part of AIP+, I took over the further development and completion of an existing website for the organization Nuru Slums – Hope for Africa. The goal was to improve the page structurally, make it more user-friendly, and build it more visually clearly.",
      "facts.toolsLabel": "Tools",
      "facts.durationLabel": "Duration",
      "facts.durationValue": "4 months",
      "facts.roleLabel": "Role",
      "facts.roleValue": "Design & Development",
      "problem.title": "Problem",
      "problem.text": "The existing website was not optimally structured in terms of structure and user guidance and appeared visually restless. Contents were partially arranged unclearly, which made orientation difficult for users.",
      "solution.title": "Solution",
      "solution.text": "I developed a clearer page structure, optimized the navigation, and redesigned the layout. The focus was on a calm visual design, good readability, and user-friendly guidance through the content.",
      ...
      "result.title": "Result",
      "result.alt": "Final website mockup",
      "reflection.title": "Reflection",
      "reflection.text": "This project showed me how crucial a clear structure and good user guidance are for the impact of a website. Working on an existing page helped me to further develop my skills in analysis, design, and implementation in a targeted way.",
