...
const translations = {
  index: {
    de: {
      ...
      "home.text": "Ich gestalte digitale und Print-Lösungen für Webdesign, Content und visuelle Kommunikation. Mein Ziel ist es, einen ruhigen, modernen und überzeugenden Auftritt zu schaffen.",
      ...
      "cards.1.text": "Im Auftrag von AIP+ erarbeitet. Ein visuelles Konzept mit klarer Gestaltung und konsistenten Wiedererkennungsmerkmalen.",
      "cards.2.image": "Projekt 2",
      "cards.2.category": "UI / Web",
      "cards.2.title": "Portfolio Webdesign",
      "cards.2.text": "Responsives Webprojekt mit Fokus auf Struktur, Lesbarkeit und Benutzerfreundlichkeit.",
      ...
      "cards.5.text": "Visuelle Gestaltung für ein Event mit Fokus auf Wiedererkennung, Klarheit und Übersicht.",
    ...
    en: {
      ...
      "cards.2.image": "Project 2",
      "cards.2.category": "UI / Web",
      "cards.2.title": "Portfolio Web Design",
      "cards.2.text": "Responsive web project focused on structure, readability, and usability.",
  ...
  project1: {
    de: {
      ...
      "intro.text": "Für dieses Projekt habe ich eine minimalistische Portfolio-Website gestaltet und umgesetzt. Das Ziel war, einen modernen und hochwertigen Auftritt zu schaffen, der professionell wirkt und sich gut für Bewerbungen eignet.",
  ...
  project2: {
    de: {
      ...
      "nav.backProjects": "Zurück zu Projekten",
      "hero.eyebrow": "UI / Web",
      "hero.title": "Portfolio Webdesign",
    ...
    en: {
      ...
      "nav.backProjects": "Back to projects",
      "hero.eyebrow": "UI / Web",
      "hero.title": "Portfolio Web Design",
      ...
      "facts.roleLabel": "Role",
      "facts.roleValue": "Design and frontend",
      "facts.toolsLabel": "Tools",
      "facts.resultLabel": "Result",
      "facts.resultValue": "Responsive portfolio presence",
  ...
  project5: {
    de: {
      ...
      "hero.text": "Ein visuelles Konzept für ein Event, das Informationen klar strukturiert und gleichzeitig eine starke, wiedererkennbare Gestaltung für verschiedene Printmedien schafft.",
      "tags.1": "Print Layout",
      ...
      "description.title": "Projektbeschreibung",
      "description.text": "Für dieses Projekt wurde ein visuelles Konzept für ein Event entwickelt, das Information, Markenwirkung und eine klare Gestaltung miteinander verbindet. Wichtige Inhalte sollten schnell erfassbar sein und gleichzeitig einen professionellen Eindruck hinterlassen.",
      "tools.title": "Tools",
      "tasks.title": "Meine Aufgaben",
